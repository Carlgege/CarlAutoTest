...
public class UiAutomatorModel {
    ...
    //private static List<BasicTreeNode> mCachedNodelist;
    ...
    public UiAutomatorModel(File xmlDumpFile) {
        ...
        //System.out.println("xmlDumpFile file path:"+xmlDumpFile.getAbsolutePath());
        ...
        //mCachedNodelist = loader.getAllNodes();
    }
    
    public List<BasicTreeNode> getmNodelist() {
		return mNodelist;
	}

    //public static List<BasicTreeNode> getmNodelist() {
	//	return mCachedNodelist;
	//}
