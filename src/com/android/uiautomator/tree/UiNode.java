...
public class UiNode extends BasicTreeNode {
    ...
    private ArrayList<String> resourceIdValueList = new ArrayList<String>();
    private ArrayList<String> descValueList = new ArrayList<String>();
    
    
    public void clearValueList() {
    	textValueList.removeAll(textValueList);
    	resourceIdValueList.removeAll(resourceIdValueList);
    	descValueList.removeAll(descValueList);
    }
    */
    ...
    public void addAtrribute(String key, String value) {
        ...
        if (key.equals("text")) {
        	...
        	textValueList.add(value);
        } else if (key.equals("resource-id")) {
        	//System.out.println("resource-id value:"+value);
        	resourceIdValueList.add(value);
        } else if (key.equals("content-desc")) {
        	//System.out.println("content-desc value:"+value);
        	descValueList.add(value);
        }
        */
        //******************************************************
    ...
    /*
    public boolean uniqueValue(String key, String value) {
